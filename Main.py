...
class AppWindow(Gtk.ApplicationWindow):
    ...
    def create_buttons(self):
        ...
        radio_wrapchar = Gtk.RadioButton.new_with_label_from_widget(radio_wrapnone, "Char Wrapping")
        ...
        radio_wrapcharword = Gtk.RadioButton.new_with_label_from_widget(radio_wrapnone, "Word-Char Wrapping")
